package no.novari.fint.consumer.models.arkivressurs;
...
public class ArkivressursCacheService extends CacheService<ArkivressursResource> {
    ...
    public ArkivressursCacheService() {
        super(MODEL, NoarkActions.GET_ALL_ARKIVRESSURS, NoarkActions.UPDATE_ARKIVRESSURS);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, NoarkActions.GET_ALL_ARKIVRESSURS, Constants.CACHE_SERVICE);
